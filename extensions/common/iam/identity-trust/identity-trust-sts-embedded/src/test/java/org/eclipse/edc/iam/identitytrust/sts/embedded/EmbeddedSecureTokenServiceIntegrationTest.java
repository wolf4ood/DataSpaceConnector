...
public class EmbeddedSecureTokenServiceIntegrationTest {
    ...
    void createToken_withoutBearerAccessScope() {
        ...
        Map<String, Object> claims = Map.of(ISSUER, issuer);
    ...
    void createToken_withBearerAccessScope() {
        ...
        Map<String, Object> claims = Map.of(ISSUER, issuer, AUDIENCE, audience);
    ...
    void createToken_shouldFail_withMissingClaims(Map<String, Object> claims) {
