...
public class MockIdentityService implements IdentityService {
    ...
    public MockIdentityService(TypeManager typeManager, String region, ParticipantContextSupplier participantContextSupplier, String faultyClientId) {
    ...
    public Result<TokenRepresentation> obtainClientCredentials(TokenParameters parameters) {
        ...
        token.setClientId(participantContextSupplier.get().getIdentity(DEFAULT_DATASPACE_CONTEXT));
