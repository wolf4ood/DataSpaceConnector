...
public class DataPlaneSelectorApiExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        // V4
        managementApiTransformerRegistry.register(new JsonObjectFromDataPlaneInstanceTransformer(createBuilderFactory(Map.of()), jsonLdMapperProvider.get()));
        ...
        managementApiTransformerRegistryV3.register(new JsonObjectFromDataPlaneInstanceV3Transformer(createBuilderFactory(Map.of()), jsonLdMapperProvider.get()));
