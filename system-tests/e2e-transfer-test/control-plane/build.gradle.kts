...
dependencies {
    ...
    implementation(project(":extensions:control-plane:transfer:transfer-consumer-pull"))
    ...
    implementation(project(":extensions:control-plane:provision:provision-edr"))
