...
public class DspApiConfigurationV2025Extension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        var profileContext = new DataspaceProfileContext(
                ...
                V_2025_1,
                () -> dspWebhookAddress.get() + "/" + DATASPACE_HTTP_PROFILE_2025_1 + V_2025_1_PATH,
    ...
    // TODO This currently lives here since we only have one DSP protocol implementation for virtual connector.
    // it should be moved once we have multiple implementations
    @Override
    public void prepare() {
