...
class CatalogServiceImplTest {
    ...
    void requestCatalog_shouldDispatchRequestAndReturnResult() {
        ...
        var result = service.requestCatalog("participantContextId", "counterPartyId", "http://provider/url", "protocol", QuerySpec.none());
    ...
    void requestDataset_shouldDispatchRequestAndReturnResult() {
        ...
        var result = service.requestDataset("participantContextId", "datasetId", "counterPartyId", "http://provider/url", "protocol");
