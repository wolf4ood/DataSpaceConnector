...
public interface ProtocolTokenValidator {
     ...
     */
    default ServiceResult<ParticipantAgent> verify(ParticipantContext participantContext, TokenRepresentation tokenRepresentation, RequestPolicyContext.Provider policyContextProvider) {
        return verify(participantContext, tokenRepresentation, policyContextProvider, Policy.Builder.newInstance().build(), null);
    }
